...
\usepackage{etoolbox}          % Garante que o pacote esteja carregado
\newbool{darkmode}             % Cria a variável booleana
\setbool{darkmode}{false}       % 'true' / 'false' 
% -----------------------------------
...
\makeatletter
\DeclareRobustCommand{\htmladdnormallink}[2]{%
  \hyper@normalise\hyper@linkurl{#2}{#2}%
}
\makeatother
...
\include{estrutura/pre-textuais/listas/lista-teoremas}
...
\include{estrutura/textuais/desenvolvimento/fundamentos_teoria_conjuntos} % Revisão de Literatura

\include{estrutura/textuais/desenvolvimento/cardinalidade} % Revisão de Literatura

\include{estrutura/textuais/desenvolvimento/infinitos} % Revisão de Literatura

\include{estrutura/textuais/desenvolvimento/hipotese_continuo} % Revisão de Literatura
