...
\begin{exemplo}[Números Surreais e Jogos]
    Em sua obra \emph{On Numbers and Games}, \citeonline{conway2001} define a classe de "Jogos" \ construídos recursivamente a partir do conjunto vazio.
