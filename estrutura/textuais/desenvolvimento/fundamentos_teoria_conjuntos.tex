...
\begin{definicao}[Produto Cartesiano]
    O produto cartesiano de \(A\) e \(B\) é o conjunto \(A \times B\) em que
    \[
...
Definida a função sucessor nós podemos abordar o Axioma \ref{ax:infinidade}: 
