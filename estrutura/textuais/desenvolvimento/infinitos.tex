...
Cantor provou que o conjunto dos números reais \(\mathbb{R}\) não é enumerável. A prova clássica utiliza o método da diagonalização \parencite[p.~429]{bertato2023}, que constrói um número real que não pode estar em nenhuma lista pré-definida de reais, mostrando assim que nenhuma enumeração de \(\mathbb{R}\) pode ser completa. A cardinalidade dos números reais é chamada de ``\textbf{cardinalidade do contínuo}'' \ e denotada por \(\mathfrak{c}\).