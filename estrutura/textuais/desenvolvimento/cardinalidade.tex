...
A partir das definições elementares de conjunto, este capítulo formaliza o conceito intuitivo de tamanho. Serão discutidas as definições rigorosas de conjuntos finitos e infinitos, contrastando as abordagens de autores clássicos como \citeonline{halmos2014} e \citeonline{lima2006}. Além disso, estabelecem-se os critérios matemáticos para comparar a magnitude de dois conjuntos através da análise de funções injetoras e bijetoras, fundamentando a noção de equipotência.
