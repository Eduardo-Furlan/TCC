...
\begin{exemplo}
    O conjunto \(X = \{\text{primeiro}, \text{segundo}, \text{terceiro}\}\) é finito. Para verificar basta encontrar um \(n \in \mathbb{N}\) e uma bijeção \(f: \ I_n \to X\), de fato, tome \(n = 3\), e \(f: \ \{1,2,3\} \to \{\text{primeiro}, \text{segundo}, \text{terceiro}\}\) tal que 

    \begin{align*}
    &f(1) \longrightarrow \text{primeiro} \\
    &f(2) \longrightarrow \text{segundo} \\
    &f(3) \longrightarrow \text{terceiro} \\    
    \end{align*}
