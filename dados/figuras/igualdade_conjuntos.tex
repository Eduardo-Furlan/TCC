\begin{figure}[H]
    ...
    \begin{scope}[local bounding box=step1]
        ...
        \node[below=0.3cm, font=\footnotesize, text=gray] at (0, -1.5) {1. \( A \subseteq B \)};
    \end{scope}
    ...
    \begin{scope}[xshift=4.5cm, local bounding box=step2]
        ...
        \node[below=0.3cm, font=\footnotesize, text=gray] at (0, -1.5) {2. \( B \subseteq A \)};
    \end{scope}
    ...
    \begin{scope}[xshift=9.5cm]
        ...
        \node[below=0.3cm, font=\footnotesize, text=gray] at (0, -1.5) {Logo, são iguais};
    \end{scope}
