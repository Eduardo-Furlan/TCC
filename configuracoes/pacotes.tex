...
\usepackage{tikz}
\usetikzlibrary{positioning, shadows, calc, shapes.geometric}
...
% Nível 1: Blackboard Bold (\mathbb) - Conjuntos Numéricos
...
% Nível 2: Caligráfico (\mathcal)
% Nota: \mathcal padrão só funciona bem com letras MAIÚSCULAS.
\newcommand{\NN}{\mathcal{N}}
\newcommand{\AAa}{\mathcal{A}} % \AA já existe (Ångström), use \AAa ou outro nome
\newcommand{\BB}{\mathcal{B}}
\newcommand{\CC}{\mathcal{C}}
\newcommand{\FF}{\mathcal{F}}
\newcommand{\PP}{\mathcal{P}} % Utíl para conjunto das partes

% Nível 3: Script (\mathscr) - Requer pacote mathrsfs
